...
const struct SpeciesInfo gSpeciesInfoGen2[] =
{
    ...
    {
        .baseHP        = 40,
        .baseAttack    = 60, //mychange 20 to 60
        .baseDefense   = 30,
        .baseSpeed     = 55,
        .baseSpAttack  = 45, //mychange 40 to 45
        .baseSpDefense = 80,
        ...
        .abilities = { ABILITY_IRON_FIST, ABILITY_NONE, ABILITY_NONE }, //mychange
    ...
    [SPECIES_LEDIAN] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_IRON_FIST, ABILITY_TECHNICIAN, ABILITY_NONE }, //mychange
        .bodyColor = BODY_COLOR_RED,
    ...
    {
        .baseHP        = 40,
        .baseAttack    = 70, //mychange 60 to 70
        .baseDefense   = 40,
        .baseSpeed     = 50, //mychange 30 to 50
        .baseSpAttack  = 40,
        .baseSpDefense = 40,
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_INSOMNIA, ABILITY_SNIPER, ABILITY_NONE }, //mychange
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_ARIADOS] =
    {
        ...
        .growthRate = GROWTH_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_SNIPER, ABILITY_NONE }, //mychange
        .bodyColor = BODY_COLOR_RED,
...
#define UNOWN_MISC_INFO(letter, _noFlip, frontWidth, frontHeight, backWidth, backHeight, backYOffset)   \
    ...
    [SPECIES_DONPHAN] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_BATTLE_ARMOR, ABILITY_STURDY, ABILITY_SAND_VEIL },
        .bodyColor = BODY_COLOR_GRAY,
