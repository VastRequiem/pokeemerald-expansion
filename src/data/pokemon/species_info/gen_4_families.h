...
const struct SpeciesInfo gSpeciesInfoGen4[] =
{
    ...
    [SPECIES_TURTWIG] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_NONE, ABILITY_OVERGROW }, //mychange
    ...
    [SPECIES_CHIMCHAR] =
    {
        ...
        .abilities = { ABILITY_IRON_FIST, ABILITY_NONE, ABILITY_BLAZE }, //mychange
    ...
    [SPECIES_PIPLUP] =
    {
        ...
        .abilities = { ABILITY_COMPETITIVE, ABILITY_NONE, ABILITY_TORRENT }, //mychange
...
#define MOTHIM_SPECIES_INFO                                                 \
    ...
    [SPECIES_COMBEE] =
    {
        ...
        .evYield_Speed = 1,
        .itemRare = ITEM_HONEY,
        .genderRatio = PERCENT_FEMALE(90), //mychange from 12.5 to 90
        .eggCycles = 15,
        .friendship = STANDARD_FRIENDSHIP,
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
