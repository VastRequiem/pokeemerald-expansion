...
const struct SpeciesInfo gSpeciesInfoGen1[] =
{
    ...
    [SPECIES_BULBASAUR] =
    {
        ...
        .abilities = { ABILITY_CHLOROPHYLL, ABILITY_OVERGROW, ABILITY_THICK_FAT }, //mychange
    ...
    [SPECIES_CHARMANDER] =
    {
        ...
        .abilities = { ABILITY_SOLAR_POWER, ABILITY_BLAZE, ABILITY_TOUGH_CLAWS }, //mychange
    ...
    [SPECIES_CHARIZARD] =
    {
        .baseHP        = 75, //mychange 78 to 75
        .baseAttack    = 101, //mychange 84 to 101
        .baseDefense   = 75, //mychange 78 to 75
        .baseSpeed     = 100,
        .baseSpAttack  = 109,
        .baseSpDefense = 75, //mychange 85 to 75
    ...
    [SPECIES_SQUIRTLE] =
    {
        ...
        .abilities = { ABILITY_SHELL_ARMOR, ABILITY_TORRENT, ABILITY_RAIN_DISH }, //mychange
    ...
    [SPECIES_BLASTOISE] =
    {
        ...
        .baseDefense   = 100,
        .baseSpeed     = 78,
        .baseSpAttack  = 90, //mychange 85 to 90
    ...
    [SPECIES_METAPOD] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SHED_SKIN, ABILITY_BATTLE_ARMOR, ABILITY_SHED_SKIN }, //mychange
        .bodyColor = BODY_COLOR_GREEN,
    ...
    [SPECIES_BUTTERFREE] =
    {
        .baseHP        = 65, //mychange 60 to 65
        .baseAttack    = 45,
        .baseDefense   = 60, //mychange 50 to 60
        .baseSpeed     = 90, //mychange 70 to 90
        .baseSpAttack  = 100, //mychange 90 to 100
        .baseSpDefense = 90, //mychange 80 to 90
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_COMPOUND_EYES, ABILITY_TINTED_LENS, ABILITY_TINTED_LENS }, //mychange
    ...
    {
        .baseHP        = 65,
        .baseAttack    = 105, //mychange 90 to 105
        .baseDefense   = 50, //mychange 40 to 50
        .baseSpeed     = 85, //mychange 75 to 85
        .baseSpAttack  = 55, //mychange 45 to 55
        .baseSpDefense = 95, //mychange 80 to 95
        .types = MON_TYPES(TYPE_BUG, TYPE_POISON),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 198,
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_BUG),
        .abilities = { ABILITY_SNIPER, ABILITY_ADAPTABILITY, ABILITY_SWARM }, //mychange
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    {
        .baseHP        = 40,
        .baseAttack    = 40, //mychange 45 to 40
        .baseDefense   = 40,
        .baseSpeed     = 56,
        .baseSpAttack  = 50, //mychange 35 to 50
        .baseSpDefense = 35,
        ...
        .abilities = { ABILITY_BIG_PECKS, ABILITY_TANGLED_FEET, ABILITY_BIG_PECKS }, //mychange
        .bodyColor = BODY_COLOR_BROWN,
    ...
    {
        .baseHP        = 63,
        .baseAttack    = 50, //mychange 60 to 50
        .baseDefense   = 55,
        .baseSpeed     = 71,
        .baseSpAttack  = 65, //mychange 50 to 65
        .baseSpDefense = 50,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 120,
    ...
    {
        .baseHP        = 83,
        .baseAttack    = 60, //mychange 80 to 60
        .baseDefense   = 70, //mychyange 75 to 70
        .baseSpeed     = 101, //mychange
        .baseSpAttack  = 115, //mychange 70 to 115
        .baseSpDefense = 70,
        .types = MON_TYPES(TYPE_NORMAL, TYPE_FLYING),
        .catchRate = 45,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_NO_GUARD, ABILITY_TANGLED_FEET, ABILITY_BIG_PECKS }, //mychange
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_RATTATA] =
    {
        ...
        .abilities = { ABILITY_GUTS, ABILITY_NONE, ABILITY_HUSTLE }, //mychange
    ...
    [SPECIES_RATICATE] =
    {
        .baseHP        = 55, //mychange 55 to 60
        .baseAttack    = 81, //mychange 81 to 92
        .baseDefense   = 60,
        .baseSpeed     = 97,
        .baseSpAttack  = 50,
    ...
    [SPECIES_RATICATE_ALOLA] = //change later
    {
        .baseHP        = 75,
        .baseAttack    = 71,
        .baseDefense   = 70,
    ...
    [SPECIES_PIKACHU] =
    {
        .baseHP        = 40, //mychange 35 to 40
        .baseAttack    = 65, //mychange 55 to 65
        .baseDefense   = P_UPDATED_STATS >= GEN_6 ? 40 : 30, //mychange
        .baseSpeed     = 100, //mychange
        .baseSpAttack  = 65, //mychange 50 to 65
...
#define RAICHU_SPEED (P_UPDATED_STATS >= GEN_6 ? 110 : 100)
    ...
    [SPECIES_RAICHU] =
    {
        ...
        .baseDefense   = 55,
        .baseSpeed     = 110, //mychange
        .baseSpAttack  = 95, //mychange 90 to 95
    ...
    [SPECIES_SANDSHREW] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_ROUGH_SKIN, ABILITY_SAND_RUSH, ABILITY_SAND_RUSH }, //mychange
        .bodyColor = BODY_COLOR_YELLOW,
    ...
    [SPECIES_CLEFABLE] =
    {
        ...
        .baseDefense   = 73,
        .baseSpeed     = 60,
        .baseSpAttack  = 95, //mychange
        .baseSpDefense = 90, //mychange
        .types = CLEFAIRY_FAMILY_TYPES,
        .catchRate = 25,
    #if P_UPDATED_EXP_YIELDS >= GEN_8
        .expYield = 242,
    ...
    [SPECIES_VULPIX] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLASH_FIRE, ABILITY_UNNERVE, ABILITY_NONE }, //mychange
        .bodyColor = BODY_COLOR_BROWN,
...
#define WIGGLYTUFF_SP_ATK   50
    ...
    [SPECIES_ZUBAT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FLYING),
        .abilities = { ABILITY_INNER_FOCUS, ABILITY_INFILTRATOR, ABILITY_INFILTRATOR }, //mychange
        .bodyColor = BODY_COLOR_PURPLE,
        .speciesName = _("Zubat"),
        .cryId = CRY_ZUBAT,
    ...
    [SPECIES_ODDISH] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_GLOOM}), //mychange 21 to 16
    },
    ...
    [SPECIES_MANKEY] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DEFIANT, ABILITY_VITAL_SPIRIT, ABILITY_NONE }, //mychange
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_ANNIHILAPE] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_DEFIANT, ABILITY_VITAL_SPIRIT, ABILITY_INNER_FOCUS }, //mychange
        .bodyColor = BODY_COLOR_GRAY,
    ...
    [SPECIES_GROWLITHE] =
    {
        ...
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_NONE, ABILITY_FLASH_FIRE }, //mychange
        .bodyColor = BODY_COLOR_BROWN,
    ...
    [SPECIES_GROWLITHE_HISUI] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_INTIMIDATE, ABILITY_ROCK_HEAD, ABILITY_FLASH_FIRE }, //mychange
        .bodyColor = BODY_COLOR_BROWN,
        .speciesName = _("Growlithe"),
        .cryId = CRY_GROWLITHE,
        .natDexNum = NATIONAL_DEX_GROWLITHE,
    ...
    [SPECIES_POLIWAG] =
    {
        ...
        .abilities = { ABILITY_SWIFT_SWIM, ABILITY_NONE, ABILITY_DAMP }, //mychange
        .bodyColor = BODY_COLOR_BLUE,
        .noFlip = TRUE,
    ...
    {
        .baseHP        = 90,
        .baseAttack    = 95, //mychange 95 to 105
        .baseDefense   = 95,
        .baseSpeed     = 70,
        .baseSpAttack  = 60, //mychange 70 to 60
        .baseSpDefense = 90, //mychange
...
#define ALAKAZAM_SP_DEF 135
    ...
    [SPECIES_BELLSPROUT] =
    {
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 16, SPECIES_WEEPINBELL}), //mychange 21 to 16
    },
...
#define GOLEM_ATTACK (P_UPDATED_STATS >= GEN_6 ? 120 : 110)
    ...
    [SPECIES_PONYTA] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_FLAME_BODY, ABILITY_INNER_FOCUS, ABILITY_FLASH_FIRE }, //mychange
        .bodyColor = BODY_COLOR_YELLOW,
        ...
        .evolutions = EVOLUTION({EVO_LEVEL, 30, SPECIES_RAPIDASH}), //mychange
    },
