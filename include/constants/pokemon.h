...
// Shiny odds
#define SHINY_ODDS 128 // Actual probability is SHINY_ODDS/65536  (mychange from 8 to 128)
...
#define MAX_PER_STAT_EVS ((P_EV_CAP >= GEN_6) ? 0 : 0) //mychange from 252 : 255 to 0 : 0
#define MAX_TOTAL_EVS 0 //mychange from 510 to 0
